 ...
 */
export type ReadonlyUint8ClampedArray = {
  // from lib.es5.d.ts
   ...
   */
  readonly slice: (start?: number, end?: number) => ReadonlyUint8ClampedArray;
  ...
  readonly valueOf: () => ReadonlyUint8ClampedArray;
   ...
   */
  readonly toReversed: () => ReadonlyUint8ClampedArray;
   ...
   */
  readonly with: (index: number, value: number) => ReadonlyUint8ClampedArray;
};
