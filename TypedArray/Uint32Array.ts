...
export type ReadonlyUint32Array = {
   ...
   */
  readonly slice: (start?: number, end?: number) => ReadonlyUint32Array;
   ...
   */
  readonly subarray: (begin?: number, end?: number) => ReadonlyUint32Array;
  ...
  readonly valueOf: () => ReadonlyUint32Array;
   ...
   */
  readonly toReversed: () => ReadonlyUint32Array;
   ...
   */
  readonly with: (index: number, value: number) => ReadonlyUint32Array;
};
