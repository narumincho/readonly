 ...
 */
export type ReadonlyBigInt64Array = {
   ...
   */
  readonly slice: (start?: number, end?: number) => ReadonlyBigInt64Array;
   ...
   */
  readonly subarray: (begin?: number, end?: number) => ReadonlyBigInt64Array;
  ...
  readonly valueOf: () => ReadonlyBigInt64Array;
   ...
   */
  readonly toReversed: () => ReadonlyBigInt64Array;
   ...
   * ```ts
   * const myNums = BigInt64Array.from([11, 2, 22, 1]);
   * myNums.toSorted((a, b) => a - b) // BigInt64Array(4) [1, 2, 11, 22]
   * ```
   *
   ...
   */
  readonly with: (index: number, value: bigint) => ReadonlyBigInt64Array;
};
