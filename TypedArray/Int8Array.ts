...
export type ReadonlyInt8Array = {
   ...
   */
  readonly slice: (start?: number, end?: number) => ReadonlyInt8Array;
   ...
   */
  readonly subarray: (begin?: number, end?: number) => ReadonlyInt8Array;
  ...
  readonly valueOf: () => ReadonlyInt8Array;
   ...
   */
  readonly toReversed: () => ReadonlyInt8Array;
   ...
   */
  readonly with: (index: number, value: number) => ReadonlyInt8Array;
};
