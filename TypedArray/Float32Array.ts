 ...
 */
export type ReadonlyFloat32Array = {
  // from lib.es5.d.ts
   ...
   */
  readonly slice: (start?: number, end?: number) => ReadonlyFloat32Array;
   ...
   */
  readonly subarray: (begin?: number, end?: number) => ReadonlyFloat32Array;
  ...
  readonly valueOf: () => ReadonlyFloat32Array;
   ...
   */
  readonly toReversed: () => ReadonlyFloat32Array;
   ...
   * ```ts
   * const myNums = Float32Array.from([11, 2, 22, 1]);
   * myNums.toSorted((a, b) => a - b) // Float32Array(4) [1, 2, 11, 22]
   * ```
   *
   ...
   */
  readonly with: (index: number, value: number) => ReadonlyFloat32Array;
};
