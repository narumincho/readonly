 ...
 */
export type ReadonlyInt32Array = {
  // from lib.es5.d.ts
   ...
   */
  readonly slice: (start?: number, end?: number) => ReadonlyInt32Array;
   ...
   */
  readonly subarray: (begin?: number, end?: number) => ReadonlyInt32Array;
  ...
  readonly valueOf: () => ReadonlyInt32Array;
   ...
   */
  readonly toReversed: () => ReadonlyInt32Array;
   ...
   * myNums.toSorted((a, b) => a - b) // Int32Array(4) [1, 2, 11, 22]
   * ```
   *
   ...
   */
  readonly with: (index: number, value: number) => ReadonlyInt32Array;
};
