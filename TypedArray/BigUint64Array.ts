 ...
 */
export type ReadonlyBigUint64Array = {
  // from lib.es2020.bigint.d.ts
   ...
   */
  readonly entries: () => IterableIterator<readonly [number, bigint]>;
   ...
   */
  readonly includes: (searchElement: bigint, fromIndex?: number) => boolean;
   ...
   */
  readonly indexOf: (searchElement: bigint, fromIndex?: number) => number;
   ...
   */
  readonly lastIndexOf: (searchElement: bigint, fromIndex?: number) => number;
   ...
   */
  readonly slice: (start?: number, end?: number) => ReadonlyBigUint64Array;
   ...
   */
  readonly subarray: (begin?: number, end?: number) => ReadonlyBigUint64Array;
  ...
  readonly valueOf: () => ReadonlyBigUint64Array;
   ...
   */
  readonly at: (index: number) => bigint | undefined;
   ...
   */
  readonly toReversed: () => ReadonlyBigUint64Array;
   ...
   * ```ts
   * const myNums = BigUint64Array.from([11, 2, 22, 1]);
   * myNums.toSorted((a, b) => a - b) // BigUint64Array(4) [1, 2, 11, 22]
   * ```
   *
   ...
   */
  readonly with: (index: number, value: bigint) => ReadonlyBigUint64Array;
};
