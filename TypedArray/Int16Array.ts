 ...
 */
export type ReadonlyInt16Array = {
  // from lib.es5.d.ts
   ...
   */
  readonly slice: (start?: number, end?: number) => ReadonlyInt16Array;
   ...
   */
  readonly subarray: (begin?: number, end?: number) => ReadonlyInt16Array;
  ...
  readonly valueOf: () => ReadonlyInt16Array;
   ...
   */
  readonly toReversed: () => ReadonlyInt16Array;
   ...
   * myNums.toSorted((a, b) => a - b) // Int16Array(4) [1, 2, 11, 22]
   * ```
   *
   ...
   */
  readonly with: (index: number, value: number) => ReadonlyInt16Array;
};
