...
export type ReadonlyUint16Array = {
   ...
   */
  readonly slice: (start?: number, end?: number) => ReadonlyUint16Array;
   ...
   */
  readonly subarray: (begin?: number, end?: number) => ReadonlyUint16Array;
  ...
  readonly valueOf: () => ReadonlyUint16Array;
   ...
   */
  readonly toReversed: () => ReadonlyUint16Array;
   ...
   */
  readonly with: (index: number, value: number) => ReadonlyUint16Array;
};
